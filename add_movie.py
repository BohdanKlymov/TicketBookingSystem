...
with app.app_context():
    ...
    movie_Inception = Movies(
        ...
        movie_jearOfRelease = "2010",
        movie_picture = "./moviePictures/Inception.jpg"
    )
